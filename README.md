...
- **All code runs client-side:** The features listed below do not rely on server-side processing. The only downside is that it is only as fast as your computer and your internet speed. 
...
- **AI Contract Tools:** Legal Draft features AI tools for drafting contracts, providing interns with valuable insights.
